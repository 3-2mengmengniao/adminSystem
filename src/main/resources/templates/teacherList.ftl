...
<div class="x-body">
  <xblock>
    ...
    -->
    <button id="addUserBtn" onclick="x_admin_show('添加用户','./addTeacher',500,400)" name="addUserBtn" class="layui-btn" style="float: right;margin-right:20px;margin-top:5px;"><i class="layui-icon">&#xe608;</i>新建账号</button>
  </xblock >
